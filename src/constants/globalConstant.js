...
export const peopleSay = [
  {
    text: ' “ Sending token has never been easier, Audaxious made web 3.0 as easy as counting 1,2,3I am very grateful and currently have no reservations thus far, you should give it a trial, its definitely worth it “',
    avatar: avatar,
    name: 'Mary Fless',
    handle: '@thebrave_J',
    platform: facebook,
