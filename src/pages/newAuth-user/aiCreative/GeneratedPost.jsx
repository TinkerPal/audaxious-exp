    ...
    <div className="">
      ...
      <div>
        <div className="flex gap-2 mb-3 items-center">
          ...
          <label
            htmlFor="some_id"
            className="text-[#EBEDED] font-Poppins text-[0.8rem] md:text-[1.25rem] font-[300]"
          >
            Select all post
          </label>
          <Checked />
        </div>
        <div className="border border-[#2A3C46] rounded-md mt-[2.68rem] max-w-[43rem] px-[0.5rem] md:px-[4rem] py-[1.5rem]">
          <div className="flex gap-2 mb-3 items-center">
            <input
              type="checkbox"
              id="some_id"
          ...
          <div>
            <div className="w-[100%] md:w-auto relative">
              <textarea
                ...
                className=" disabled:cursor-not-allowed bg-transparent outline-none placeholder:text-[#A5A5A5] w-[100%] lg:w-[30rem] font-[275] border-[#436C82] bg-[#081017] border-[0.25rem] border-dashed border-opacity-[80%] rounded-lg px-[1rem] py-[0.5rem] text-[0.75rem] font-Poppins"
              ></textarea>
