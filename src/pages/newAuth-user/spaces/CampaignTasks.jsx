...
const CampaignTasks = () => {
  ...
  //     url: "audaxious.com",
  //   };
  //   // Push the selected task to the tasks array
          ...
          <div>
            ...
            {selectedTask.map((task, index) => (
              <div className="flex gap-2 md:gap-5 my-5" key={index}>
                <div className="cursor-pointer py-[0.56rem] w-[15rem] px-[1rem] rounded-md border-[1px] border-[#295D7C4D] border-opacity-[30%] flex items-center justify-between">
                  <span>
                    <img
                      src={task.image}
                      alt=""
                ...
                <div className="relative w-[100%]">
                  ...
                  />
                  <span className="absolute right-3 top-3 md:top-3 text-[0.7rem] md:text-[0.875rem] font-Poppins font-[300] text-[#79C4EC]">
                    <Cancel />
                  </span>
                </div>
              </div>
