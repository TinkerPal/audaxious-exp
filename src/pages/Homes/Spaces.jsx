          ...
          {SPACES &&
            [...SPACES, ...SPACES].map((space, index) => (
              <NavLink to={`/spaces/${space.id}`} key={index}>
                <div className="px-[0.5rem] md:px-[1.5rem] pt-[0.75rem] min-w-[18rem] max-w-[28rem] hover:border-[3px] pb-[1.25rem] border-[#2A3C46] border border-opacity-[80%] bg-ElipseBg bg-no-repeat bg-cover rounded-[16px] cursor-pointer">
