...
export default function Web3Projects2() {
  return (
        ...
        <div className="grid items-center grid-cols-1 mt-12 gap-y-0 lg:grid-cols-5 sm:mt-20 gap-x-4">
          <div className="space-y-8 lg:pr-16 xl:pr-24 lg:col-span-2 lg:space-y-12">
            <div className="flex items-start">
              <svg
                className="flex-shrink-0 text-[#DCFCE7] w-9 h-9"
              ...
              <div className="ml-5">
                ...
                <p className="mt-3 text-base text-white">
                  Customizable no-code campaign templates with task and action
                  blocks designed to boost engagement
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-5">
                ...
                <p className="mt-3 text-base text-white">
                  Create engaging content with AudaXious AI creatives. Use
                  sentiment, keywords or reference post to create compelling
                  contents
                </p>
              </div>
            </div>
